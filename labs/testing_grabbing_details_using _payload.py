...
excel = pd.ExcelFile("./Outputs/merged_outputs/Test_combined.xlsx")
...
for sheet in excel.sheet_names:
    # all_sheets.append(
    #     pd.read_excel(
    #         "./Outputs/merged_outputs/Test_combined.xlsx",
    #         sheet_name=sheet,
    #         engine="openpyxl",
    #     )
    # )
    ...
    with pd.ExcelWriter(
        "./Outputs/merged_outputs/Test_combined.xlsx", engine="openpyxl"
    ) as writer:
        writer.book = openpyxl.load_workbook(
            "./Outputs/merged_outputs/Test_combined.xlsx"
        )
