...
def merge_excel_files(
    folder_path: str, output_file: str, exam_name: str, log_server
) -> None:
    """
...
def grab_bundle_details_using_script(
    qp_codes: List[str], path: str, exam_name: str, log_server
) -> None:
    headers = [
        "Sl.No.",
        "Bundle Code",
    ...
    for qp_code in qp_codes:
        ...
        log_server(f"Fetching deatils of: {qp_code}", "INFO")
    ...
    merge_excel_files(path, output_file, exam_name, log_server)
...
def auto_qp_series_generator(
    series: str, range_start: int, range_end: int, exam_name: str, log_server
) -> None:
    """
    ...
    try:
        ...
        log_server("Fetching captcha solution...", "ERROR")
...
def custom_qp_range(qp_codes: List[str], exam_name: str, log_server) -> None:
    """
    ...
    try:
        ...
        log_server(f"Error execeuting Script in fun custom_qp_range: {e}", "ERROR")
        log_message(
